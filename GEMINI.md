...
- [x] **Organization Refactoring**: Rename the organization/app identity from `skorin/numi-kde` to a more formal `numi-kde` and update contact email to `dev@skorin.online`.
